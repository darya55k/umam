  ...
  <div class="content">
    <div class="content__row">
      <div class="content__col content__col--2">
        ...
        <h2 class="mb-0">Программа перевода "41.03.01 Управление международными проектами и программами"</h2>
          ...
          <div class="form">
            ...
            <div class="dl dl--w100 mb-100">
              ...
              <div class="dl__item">
                ...
                <div class="dl__dd color-orange">На рассмотрении</div>
              </div>
            </div>
          </div>
        </div>
